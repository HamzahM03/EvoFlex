...
export const calculateCalories = (age, gender, height, weight, activityLevel, goalType) => {
  let bmr;
  if (gender === "male") {
  ...
  if (goalType === "weight_loss") return dailyCalories - 500;
  if (goalType === "weight_gain") return dailyCalories + 500;
  if (goalType === "muscle_gain") return dailyCalories + 250;
